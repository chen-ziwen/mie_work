...
#container
    ...
    a(href="https://en.wikipedia.org/wiki/Violet_(color)")
        | VIOLET
#linkBack(style="position:absolute;right:0px;top:0px;background-color:#333;margin:0;width:60px;padding:5px")
    a(href="https://rilling.dev/projects/" target="_blank" style="font-size:14px;text-decoration:none;color:#fff;padding:0 0 0 5px;font-family:sans-serif")
        | My Site
</template>
